...
def main():
    ...
    planes.append(Plaine(cube_v, edges, surfaces, colors, np.array([1, 0, 0]), np.array([0,.2,0]), 0, 1, 0.02, 0.1, 5, 5))
    planes.append(Plaine(cube_v, edges, surfaces, colors, np.array([1, 0, 0]), np.array([0,.2,0]), 0, 1, 0.02, 0.1, 0, 0))
    planes.append(Plaine(cube_v, edges, surfaces, colors, np.array([1, 0, 0]), np.array([0,.2,0]), 0, 1, 0.02, 0.1, -5, -5))
